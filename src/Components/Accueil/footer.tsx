export default function Footer() {
    return (
        <footer className="container-fluid bg-primary fixed-bottom mt-5">
            <div className="d-flex justify-content-around">
                <div>
                    <h6>Copyright & Remerciements</h6>
                    ...
                    <a href="https://icones8.fr/">https://icones8.fr/</a>
                </div>

                <div>
                    et mes remerciements particulier à Arnaud, Kévin,
